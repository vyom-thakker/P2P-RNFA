...
variable CO2Eq;
CO2EqConstr.. CO2Eq=e=DeltaE*60*(10**(-9));
*ieo etsap 60kgCO2/TJ
...
CostInEq.. costIn=e=sum(j,RNFAU('395',j)*m(j)*0.221)+sum(j,RNFAU('415',j)*m(j)*0.0014);
...
*  Solve P2PRNFA using LP minimizing costIn;
*     LCCDummy=LCC.l;
*    LCC.up=LCCDummy;
