...
*     t_y('refin')      = t_y('refin') + 0.01;
      taxrate('metls','txo') = taxrate('metls','txo') - 0.01*100;
      txo('metls')     =   0.01*taxrate("metls","txo")*y('metls');
      t_y('metls')      = txo('metls')/y('metls');
*      t_y('metls')      =     t_y('metls') - 0.01;

*     tax_ref = t_y('refin')*100;
      tax_ref = t_y('metls')*100;

      solve gemtap using mcp;
      fx11.ap = 1;

*      put tk('refin');
*      put taxrate('metls','txo');
      put tax_ref;
      put p_y.L('mines');
      put p_y.L('refin');
      put p_y.L('chem');
